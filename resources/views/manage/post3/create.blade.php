...
@section('content')
  <div class="flex-container">
    ...
    <form action="{{route('post3.store')}}" method="post">
      {{ csrf_field() }}
      <div class="columns">
        <div class="column is-three-quarters-desktop is-three-quarters-tablet">
          <b-field>
            <b-input type="text" placeholder="Người Tạo" name="Creator" required size="is-large" >
            </b-input>
          </b-field>
          ...
          <b-field class="m-t-40">
            <b-input type="textarea"
                placeholder="Enter report..." name="Content" rows="10">
            </b-input>
          </b-field>
